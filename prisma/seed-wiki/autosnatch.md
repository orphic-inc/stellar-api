...
Left unchecked, the entire subsidy accrues to whoever wrote the best script. The members the subsidy is aimed at, whose ratios most need the relief, are exactly the ones least likely to be running one. The rule keeps freepass allocated by participation rather than by tooling.
