...
- ✅ IRCScore (**cap 2** — a deliberately thin signal until real IRC traffic exists, #141; ADR-0013) and StylesheetScore (cap 6, PRD-03, now with the #121 tier-escalation curve and the #122 signed −1 dead-link penalty) — registered ahead of the v0.0.x roadmap.
...
The 9 live dimensions round out to ~12 with these. The cap budget is currently ≈48 at uniform weight 1.0; as these land, rebalance the per-dimension `weight`s rather than letting the sum drift.
