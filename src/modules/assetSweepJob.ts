/**
 * Background job driving the asset orphan sweep (ADR-0026 Phase 2, #342).
 * Same shape as `linkHealthJob`: a startup delay so a booting container is not
 * doing collection work while it seeds, then a daily cycle.
 */
